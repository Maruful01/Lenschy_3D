  ...
  >
    ...
    >
      ...
      >
        ...
        <!-- This HTML video element is not for “showing” the camera on screen directly — it’s a live HTML element that keeps the webcam stream running in the background. -->
        <video
          ref="webcamRef"
          autoplay
          playsinline
