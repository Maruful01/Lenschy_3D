...
const GLTF_TEMPLE_LEFT_NAME = "Temple"; // e.g. "Temple_L_End"
const GLTF_TEMPLE_RIGHT_NAME = "Temple"; // e.g. "Temple_R_End"
...
export function useVirtualTryOn(
  ...
  const onResults = (results: any) => {
    ...
    const yawFactorTemple = 1 + -9 * (yawClamped / maxYaw); // 1.0 → 1.5
